    ...
    <div className="fw-page" style={{ background: C.bg, color: C.txt, fontFamily: 'Inter, sans-serif', overflowX: 'hidden' }}>
      ...
      <section id="cta-finale" style={{ padding: '100px 8vw', textAlign: 'center', background: `radial-gradient(ellipse 80% 60% at 50% 100%,rgba(75,107,251,0.12) 0%,transparent 70%)` }}>
        ...
        <div data-reveal style={{ ...rev(0.2), display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
          <a href="mailto:info@freyrtechnology.it" style={{ fontSize: 13, fontWeight: 500, color: '#fff', padding: '10px 22px', borderRadius: 8, background: C.acc, border: `1px solid ${C.acc}`, textDecoration: 'none', transition: 'opacity 0.2s' }}>
            Prenota una consulenza
          </a>
          <a href="mailto:info@freyrtechnology.it" style={{ fontSize: 13, fontWeight: 400, color: C.txt, padding: '10px 22px', borderRadius: 8, border: `1px solid ${C.border}`, background: 'transparent', textDecoration: 'none', transition: 'border-color 0.2s' }}>
