...
@media(max-width:900px){#hero{min-height:min(100svh,780px)}.hero-center{top:35%;width:min(100%,760px)}.hero-title{font-size:clamp(62px,9vw,108px)}.hero-kicker{font-size:clamp(28px,3.6vw,44px)}.hero-bottom{width:min(100%,740px);padding:24px 20px 0}#hero canvas{transform:scale(1.01);inset:-2% 0 0 0}}
@media(max-width:640px){#hero{min-height:min(100svh,720px)}.hero-center{top:32%;padding:0 18px}.hero-title{font-size:clamp(52px,15vw,78px);line-height:.98}.hero-kicker{margin-top:8px;font-size:clamp(24px,7.2vw,34px)}#hero canvas{inset:0;transform:scale(1);transform-origin:center center}.hero-bottom{bottom:22px;padding:18px 16px 0;gap:16px}.hero-sub{font-size:15px;line-height:1.74}.hero-actions{width:100%;flex-direction:column;align-items:center}.btn-primary,.btn-ghost{width:min(100%,320px);padding:15px 22px;text-align:center}}
