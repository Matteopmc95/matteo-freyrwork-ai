...
@media(max-width:640px){#hero{min-height:780px;padding-top:90px;padding-bottom:70px;display:flex;flex-direction:column;justify-content:space-between}.hero-center{position:relative;top:auto;left:auto;transform:none;margin:0 auto;padding:0 18px;width:100%}.hero-title{font-size:clamp(52px,15vw,78px);line-height:.98}.hero-kicker{margin-top:8px;font-size:clamp(24px,7.2vw,34px)}#hero canvas{inset:auto 0;top:40%;height:42%;transform:scale(1);transform-origin:center center}.hero-bottom{position:relative;bottom:auto;left:auto;transform:none;margin:0 auto;width:100%;padding:0 16px;gap:18px;background:transparent}.hero-sub{font-size:15px;line-height:1.74;margin-bottom:4px}.hero-actions{width:100%;flex-direction:column;align-items:center;gap:10px}.btn-primary,.btn-ghost{width:min(100%,320px);padding:15px 22px;text-align:center}}
